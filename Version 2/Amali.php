...
$result=array(//array pertama=pelajar
	...
	"Fahim Aideed" => array ('KPD4015'=>60,'SEJARAH'=>72,'DISCRETEMATH'=>53,'KPD4024'=>79,'P.ISLAM'=>75),
	"Nadia Nabila" => array ('KPD4015'=>96,'SEJARAH'=>92,'DISCRETE MATH'=>93,'KPD4024'=>82,'P.ISLAM'=>76),
	);
foreach ($result as $Pelajar => $value{
	echo "Pelajar: .$Pelajar"; // 1 - P";
	echo "<br>";
	} foreach ($value as $subjek => $result) // 2 - $result
	{
		echo "Subjek: ".$subjek. "Result: ".$result; // 3 -$result
		echo "<br>";
	}	echo "-----------------------------------------------------";
		echo "<br>";
})
